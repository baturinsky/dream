...
export const FaceSprites = 0x10, BodySprites = 0x20, ToolSprites = 0x30, LegSprites = 0x38,
  ItemSprites = 0x40, TreeSprites = 0x70, BuildingSprites = 0x80, AspectSprites = 0x90;
